...
const skill = ({src= "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original.svg" , name = "Java"}) => {
  ...
  return (
    <div className="text-white border-2 border-primary flex max-w-fit gap-2 items-center py-1 px-4 rounded hover:shadow-primary-glow transition duration-300 ease-in-out cursor-pointer">
